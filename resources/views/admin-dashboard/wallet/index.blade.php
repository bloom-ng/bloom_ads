<x-user-layout page="wallet">
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="text-3xl text pb-6">Organization Wallets</h1>

            <div class="w-full mt-6">
                <div class="dashboard text overflow-auto p-6 rounded-lg shadow-sm">
                    @if (!$organization)
                    ...
                    @else
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @forelse ($organization->wallets as $wallet)
                                <div class="dashboard text border rounded-lg shadow-sm p-6">
