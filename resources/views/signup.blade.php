...
<body>
    <section class="bg-white">
        ...
        <section class="flex flex-col w-full items-center bg-[url('/images/lines.png')] bg-cover bg-center lg:mb-16">
            <div class="bg-gradient-to-r from-[#FFE5C680] to-[#FFBB6780] mt-10 mb-10 mx-5 p-14 md:p-16 lg:p-20 rounded-3xl items-center text-center ">
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-14">How do you plan <br>to collaborate with us?</h1>
